...
import cl.duoc.orden_service.exception.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OrdenNoPuedeCrearse.class)
    public ResponseEntity<?> errorValidacion(OrdenNoPuedeCrearse ex) {
    ...
    @ExceptionHandler(OrdenNoExiste.class)
    public ResponseEntity<?> errorValidacion(OrdenNoExiste ex) {
    ...
    public ResponseEntity<?> errorValidacion(StockInsuficiente ex) {
